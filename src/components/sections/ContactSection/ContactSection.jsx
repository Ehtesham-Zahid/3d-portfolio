...
import ContactLottie from "../../../assets/Lotties/contact-lottie-2.json";
import { Fade } from "react-awesome-reveal";

const ContactSection = () => {
  return (
    <div id="Contact" className="mt-20" name="contact-section">
      <p className="text-cyan-500 font-black text-center text-5xl  mt-20 sm:mb-10">
        Contact Me
      </p>
